...
class Resultado1 {
    // 9
    // 14 -226 189 -143 127 -243 -109 208 12
    ...
    public static List<Integer> ForecastTermometer(List<Integer> T) {
        ...
        for (int i = 0; i < T.size() ; i++) {
            ...
            while(!temperaturas.empty() && T.get(i) > temperaturas.peek() ) {
...
public class ForecastTermometer {
    public static void main(String[] args) throws IOException {
        ...
        List<Integer> result = Resultado1.ForecastTermometer(T);
